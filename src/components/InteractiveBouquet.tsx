...
const flowers: FlowerItem[] = [
  {
    ...
    preview: 'Siempre estuviste ahí para mí...',
    message:
      'Siempre estuviste ahí cuando más lo necesité. En momentos difíciles o de incertidumbre, tus palabras, tus consejos y tu fe en mí fueron un pilar inmenso. Jamás olvido a quien me tendió la mano con el corazón sincero.',
  ...
  },
  {
    ...
    message:
      'Aunque hoy nuestros caminos sean distintos y no seamos pareja, el cariño, el respeto y la enorme estima que te tengo siguen intactos. Fuiste alguien sumamente importante y sigues siendo una de las personas más especiales que tengo la suerte de conocer.',
  ...
  },
  {
    ...
    message:
      'Gracias por tu paciencia infinita, por escucharme siempre sin juzgar y por esa empatía que te hace única. Tienes un corazón noble y una luz hermosa que ilumina a quienes te rodean.',
    color: 'from-amber-300 to-yellow-400',
    icon: '💛',
  },
  {
    id: 4,
    name: 'Girasol de los Recuerdos',
    title: 'Lo Mejor de Nuestro Camino',
    preview: 'Me quedo con lo más bonito...',
    message:
      'Me quedo siempre con las mejores vivencias, con las risas compartidas y con todo lo bueno que aprendí a tu lado. Conocer y compartir tiempo contigo fue una etapa hermosa de la que siempre estaré agradecido.',
    color: 'from-yellow-400 to-amber-500',
    icon: '🌻',
  },
  {
    id: 5,
    name: 'Flor de la Amistad y Lealtad',
    title: 'Gracias por Tanto',
    preview: 'Mi agradecimiento sincero...',
    message:
      'Gracias por todo, de corazón. Por cada detalle, por cada palabra de aliento y por seguir estando presente. Te deseo siempre lo más bonito del mundo porque te lo mereces de verdad.',
...
export const InteractiveBouquet: React.FC<InteractiveBouquetProps> = ({
  ...
  const handleFlowerClick = (flower: FlowerItem) => {
    ...
    // Pequeño estallido de chispas en la flor
    confetti({
      particleCount: 20,
      spread: 50,
      origin: { y: 0.6 },
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div className="relative w-72 h-72 sm:w-80 sm:h-80 my-2 flex items-center justify-center">
        {/* Halo resplandeciente detrás del ramo */}
        ...
        >
          ...
          {/* Envoltorio de papel de regalo con lazo */}
          <path
        ...
        {/* Las 5 Flores Interactivas Táctiles (Posiciones sobre los tallos) */}
        {/* Flor 1: Centro Superior */}
        <button
        ...
        {/* Flor 2: Lateral Izquierda Arriba */}
        <button
        ...
        {/* Flor 4: Lateral Izquierda Media */}
        <button
      ...
      {/* Modal / Tarjeta con la dedicatoria de la flor seleccionada */}
      {selectedFlower && (
        <div
